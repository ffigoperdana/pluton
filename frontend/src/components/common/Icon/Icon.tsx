...
const Icon = ({ type, color = 'currentColor', size = 16, title = '', classes = '' }: IconProps) => {
   return (
      <span className={`icon ${classes}`} title={title}>
         ...
         {type === 'folder-open' && (
            <IconWrapper size={size} viewBox="0 0 576 512">
               <path d="M0 0h576v512H0z" fill="none" />
               <path
                  fill={color}
                  d="M527.9 224H480v-48c0-26.5-21.5-48-48-48H272l-64-64H48C21.5 64 0 85.5 0 112v288c0 26.5 21.5 48 48 48h400c16.5 0 31.9-8.5 40.7-22.6l79.9-128c20-31.9-3-73.4-40.7-73.4M48 118c0-3.3 2.7-6 6-6h134.1l64 64H426c3.3 0 6 2.7 6 6v42H152c-16.8 0-32.4 8.8-41.1 23.2L48 351.4zm400 282H72l77.2-128H528z"
               />
            </IconWrapper>
         )}
         {type === 'folders' && (
         ...
         {type === 'update' && (
            <IconWrapper size={size} viewBox="0 0 24 24">
               ...
               <path
                  fill="currentColor"
                  d="m18 22l3-3l-.7-.7l-1.8 1.8V16h-1v4.1l-1.8-1.8l-.7.7zM12 4L6.075 7.425L12 10.85l5.925-3.425zM3 15.975v-7.95q0-.55.263-1T4 6.3l7-4.025q.25-.125.488-.2T12 2t.525.075t.475.2L20 6.3q.475.275.738.725t.262 1V12h-2V9.1l-7.025 4.05L5 9.1v6.85l6 3.475v2.3L4 17.7q-.475-.275-.737-.725t-.263-1m11.463 6.563Q13 21.075 13 19t1.463-3.537T18 14t3.538 1.463T23 19t-1.463 3.538T18 24t-3.537-1.463M12 11.726"
               />
            </IconWrapper>
         )}
         {type === 'file-new' && (
